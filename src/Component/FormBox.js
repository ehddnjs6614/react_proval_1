    ...
    <div>
      <header>
        <div class="logo_box">
          ...
          <div class="page_title">견적양식 보관함</div>
        </div>
            ...
            <ul>
              <li>
                <div class="list_li list_head">
                  <div class="table_title">양식이름</div>
                  <div class="table_desc">XX12628</div>
                </div>
                <div class="list_li">
                  <div class="table_title">저장날짜</div>
                ...
                <div class="list_li bb_0">
                  <button class="btn list_btn">양식변경</button>
                  <button class="btn list_btn">견적요청</button>
                </div>
                {/* <!-- // hide_box --> */}
